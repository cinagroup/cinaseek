...
<p>Authorization complete. You may close this tab and return to CinaSeek.</p></body></html>`;
...
const INVALID_LINK_HTML = page("Authorization Link Expired", "#d97706",
  "This authorization link is invalid or has expired. Please return to CinaSeek and try again.");
...
export class GatekeeperVendor extends WorkerEntrypoint<Env> implements GatekeeperVendorIface {
  async describe(): Promise<VendorDescription> {
    return {
      ...
      description:
        "Connect your Atlassian Confluence site to let CinaSeek search, read, and edit the pages, " +
