...
import { insertSpeechTranscript, type SpeechInputError } from "../../../speech-input";
import { SpeechInputButton } from "../../../components/chat/SpeechInputButton";
...
export const ChatComposer = ({
  ...
  /** Reports state that must survive before the workspace session can suspend. */
  ...
  const handleSpeechError = (error: SpeechInputError) => {
    const messageKey = {
      ...
      "model-unavailable": "chat:composer.voiceModelUnavailable",
      "rate-limited": "chat:composer.voiceRateLimited",
      "quota-exceeded": "chat:composer.voiceQuotaExceeded",
      "settings-failed": "chat:composer.voiceSettingsFailed",
        ...
        <div className="flex items-center justify-between gap-1.5 px-3 pb-1.5">
          ...
          <div className="ml-auto flex min-w-0 flex-shrink items-center gap-1.5">
              ...
              <SpeechInputButton
                ...
                disabled={isSending || isAgentActive || isBlocked}
